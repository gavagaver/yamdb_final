# Generated by Django 3.2 on 2023-05-04 18:51
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bio', models.TextField(blank=True, max_length=254, null=True, verbose_name='о себе')),
                ('role', models.CharField(choices=[('moderator', 'Модератор'), ('admin', 'Администратор'), ('user', 'Пользователь')], default='user', max_length=254, verbose_name='Роль')),
